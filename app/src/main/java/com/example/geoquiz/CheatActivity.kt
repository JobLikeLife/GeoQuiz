...
class CheatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        answerIsTrue = intent.getBooleanExtra(EXTRA_ANSWER_IS_TRUE, false)  //将newIntent传递过来的字符串赋值给成员变量
        Cheat_Nums = intent.getIntExtra(EXTRA_CHEATE_NUMS,3)
        ...
        showAnswerButton.setOnClickListener {
            ...
            setAnswerShownResult(true)  //设置作弊显示通知结果true，作弊了
        }
    }
    ...
    private fun setAnswerShownResult(isAnswerShown: Boolean) {
        val data = Intent().apply {
            ...
            putExtra(EXTRA_CHEATE_NUMS, Cheat_Nums)
        }
